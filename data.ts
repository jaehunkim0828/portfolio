...
export const projectAll = [
    { 
        ...
        { 
            name: '요약 🖍', 
            content: ['처음으로 Next.js를 이용해서 개발하게 되었습니다. Next.js사용한이유는 요즘 뜨는 프레임워크이고 page 관리면에서 React와 다르게 따로 라이브러리를 사용하지않고 자체적으로 라우팅 해주는 방식이 흥미로워서 개발하게 되었습니다. css media 쿼리도 사용하면서 웹사이트를 반응형으로 제작하게 되었습니다.', 'TFT story 웹사이트는 롤토체스 게임에서 사용되는 덱을 만들고 공유하는 웹사이트 입니다. 다른 롤토체스 웹사이트를 사용하면서 없어서 불편했던 기능을 만들어보고 싶었고 유저수를 늘려서 커뮤니티 웹사이트를 만들어 보고싶어서 제작하게 되었습니다. ']
        },
         { 
            name: '개발 기간 ⏰', 
            content: ['22.01 - 22.02']
        ...
        { 
            name: '사용한 기술들 🛠',
            content: ['Next.js', 'Typescript', 'React.js', 'scss', 'express.js', 'Mysql']
        }, 
        { 
            name: '인원 🙃', 
            content: ['1명']
    ...
    { 
        url: ['https://github.com/jaehunkim0828/voca-test-aws', 'https://dailyvocatest.tk/'],
        name: 'Voca Test', 
        image: [vocatest,vocatest2, vocatest3], parts: [
        { 
            name: '요약 🖍', 
            content: 
            [
        ...
        { 
            name: '메인 기능 🗝', 
            content: ['단어장 생성하기', '간단한 로그인기능', '단어 생성하기', '시험보기', '테스트 결과 확인하기']
        }, 
        { 
            name: '사용한 기술들 🛠', 
    ...
    { 
        ...
        parts: [
            ...
            { 
                name: '알게된 점 📖', 
                content: ['React와 다르게 Next에서는 라이브러리 설치 없이 next 자체적으로 useRouter을 이용해서 routing을 할 수 있습니다.', 'nextron을 배포하는 과정에서 map 버전을 배포하기 위해서 맥 인증키를 발급 받아야 한다는 것을 알게 되었습니다. 맥의 경우에는 사인키로 빌드해야 정상적으로 동작합니다. Developer ID Application을 생성하고 다운로드하고 키체인에 등록하면 사인키가 정상적으로 작동하게 됩니다.']
            }
        ]
    },
    { 
    ...
    { 
        ...
        parts: [
            { 
                name: '요약 🖍',
                content: ['React를 이용해서 처음으로 개발한 프로젝트입니다. naver map api와 slide image, drop down... library를 이용해서 웹사이트를 만들어 보았습니다.']
            },
            { 
                name: '개발 기간 ⏰', 
                content: ['20.12 - 21.02']
